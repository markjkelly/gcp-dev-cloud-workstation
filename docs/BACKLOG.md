...
| F-0002 | Scratch E2E Integration Test | [F-0002](specs/F-0002-scratch-e2e-test.md) | P0 | done | SWE-1 | feature/scratch-e2e-test | F-0001 | Implemented python helper to avoid invalid gcloud add-iam-policy-binding commands |
