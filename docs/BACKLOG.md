...
| F-0010 | Align Terraform and Setup Script for Full E2E Coverage | docs/specs/F-0010-align-terraform-setup.md | P1 | in-progress | SWE | feature/align-terraform-setup | F-0002 | Align Terraform defaults to test workstation, rename sway_* resources to generic names, add API enablement, add snapshot policy to setup script, document both setup paths |
